...
// The site is cookieless and consent-free by construction: usage is counted by cookieless
// Cloudflare Web Analytics (a script that sets no cookie and keeps no identifier) and form protection is a
